...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var headers, llmAvailable, response, extendedResponse, errorResponse;
    return __generator(this, function (_a) {
        ...
        try {
            ...
            llmAvailable = llmService_1.LLMService.isAvailable();
            response = {
                status: 'ok',
                timestamp: new Date().toISOString(),
                version: '1.0.0'
            };
            extendedResponse = __assign(__assign({}, response), { services: {
